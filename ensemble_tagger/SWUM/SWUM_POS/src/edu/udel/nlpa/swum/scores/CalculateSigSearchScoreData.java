...
public class CalculateSigSearchScoreData extends AbstractScoreData {
	
	protected SWUMScore swum;
	protected IElementScore name;
	protected IElementScore bow = null;
	private double name_score = 0d;
	protected IElementScore ssig;
	
	public CalculateSigSearchScoreData(DoraScore d, IElementScore s, SWUMScore swum2, IElementScore name2, IElementScore bow2) {
		super(d);
		swum = swum2;
		name = name2;
		bow = bow2;
	...
	public CalculateSigSearchScoreData(DoraScore d, IElementScore s, SWUMScore swum2, IElementScore name2) {
		super(d);
		swum = swum2;
		name = name2;
		ssig = s;
